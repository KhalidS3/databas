...
loadSqlIntoSkolan "user" "pass" "ddl_all.sql" "Create tables and views"
...
loadSqlIntoSkolan "user" "pass" "dml_insert_csv.sql" "Importera Excel till tabel"
loadSqlIntoSkolan "user" "pass" "dml_join2.sql" "Skapar vyn v_planering"
