...
--
-- Create prodcedure for insert into account
--
...
CALL create_account('1337', 'Mega', 50.0);
-- CALL show_balance();
...
--
-- Create procedure for the edit account details.
--
...
CALL edit_account('1337', 'Mega', 14.0);
SHOW WARNINGS;
