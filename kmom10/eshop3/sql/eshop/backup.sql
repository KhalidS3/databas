...
INSERT INTO `logg` VALUES (1,'2021-03-26 18:38:41','New product','kaffe1'),(2,'2021-03-26 18:38:41','New product','te1'),(3,'2021-03-26 18:38:41','New product','kaffemix1'),(4,'2021-03-26 18:38:41','New product','skiva1'),(5,'2021-03-26 18:38:41','New product','kaffemix2');
...
INSERT INTO `order` VALUES (1,1,'2021-03-26 18:38:41','2021-03-26 18:39:03',NULL,NULL,NULL),(2,1,'2021-03-26 18:38:41',NULL,NULL,NULL,NULL),(3,2,'2021-03-26 18:38:41',NULL,NULL,NULL,NULL),(4,3,'2021-03-26 18:38:41',NULL,NULL,NULL,NULL),(5,4,'2021-03-26 18:38:41',NULL,NULL,NULL,NULL),(6,4,'2021-03-26 18:38:41',NULL,NULL,NULL,NULL),(7,5,'2021-03-26 18:38:41',NULL,NULL,NULL,NULL);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `search_log` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`user`@`%` PROCEDURE `search_log`(
    s_produkt VARCHAR(45) 
)
BEGIN
    SELECT * FROM logg
        WHERE produkt LIKE s_produkt;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`user`@`%` PROCEDURE `show_picklist`()
BEGIN
    SELECT
        o_r.produktid,
        o_r.antal,
...
-- Dump completed on 2021-03-29 13:27:52
